...
INSERT INTO TRIPS (title, city, country, start_date, end_date, owner_id) VALUES ('DAVID IS GOING TO TURKEY', 'ISTANBUL', 'TURKEY', '2018-05-04', '2019-05-18', 3);
...
insert into activities (trip_id, description, date_of_activity, start_time) values (1, 'get in-n-out', '2018-05-04', '1:00PM');
insert into activities (trip_id, description, date_of_activity, start_time) values (2, 'get laksa', '2018-05-08', '11:00AM');
...
insert into invitations (user_email, trip_id, owner_id) values ('david@gmail.com', 2, 2);